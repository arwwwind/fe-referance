  ...
  render() {
    ...
    return (
      <Form form={form} layout="vertical" hideRequiredMark onSubmit={this.onSubmit} style={style} shouldValidate={false}>
        ...
        <Row gutter={20}>
          <Col span={12}>
            <Form.Item label="Is there a QME waiver?">
              {getFieldDecorator('walkthrough.QMEWaiver', {
                initialValue: valueOrUndefined(this.state.walkthrough.QMEWaiver)
              })(
                <Select
                  size="large"
                  style={{ width: '100%' }}
        ...
        <Footer percent={56.25} goBack={this.props.goBack} step={step} lastStep={false} onSubmitClick={this.props.onRequestedStatusChange} />
      </Form>
    );
  }
}
