  ...
  render() {
    ...
    return (
      <Form form={form} layout="vertical" hideRequiredMark onSubmit={this.onSubmit} style={style} shouldValidate={false}>
        ...
        <Row gutter={20}>
          <Col span={12}>
            <div className="form-step-title m-b-xxl">Confirm DWC 1</div>
            <Form.Item label="Do you have a DWC1">
              {getFieldDecorator('walkthrough.DWC1', {
                initialValue: valueOrUndefined(this.state.walkthrough.DWC1)
              })(
                <Select
                  size="large"
                  style={{ width: '100%' }}
        ...
        <Footer percent={81.25} goBack={this.props.goBack} step={step} lastStep={false} onSubmitClick={this.props.onRequestedStatusChange} />
      </Form>
    );
  }
}
